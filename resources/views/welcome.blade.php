    ...
    <div class="container">
            <div class="">
                ...
                <div class="text-center">
                    <a class="btn btn-primary font-weight-bold" href="">{{ $users->count() }} {{ __('User(s)') }}</a>
                    <a class="btn btn-primary font-weight-bold" href="">{{ $projects->count() }} {{ __('Project(s)') }}</a>
    ...
    <div class="container pt-5">
        <div class="row">
            <div class="col-md-6">
                ...
                <img src="/images/task.svg" class="img background-image">
            ...
            <div class="col-md-6">
                ...
                <img src="/images/project.svg" class="img background-image">
